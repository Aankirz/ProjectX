    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="mt-4">
        ...
        <div className="flex flex-col">
           ...
           <div className="relative top-8 p-2 px-4 ml-3 font-bold text-xl rounded-lg z-10 w-fit border border-gray-900 bg-white ">{quote.username}</div>
        </div>
        <div className="m-9">Interest : {quote.interest}%</div>
        <div className="relative top-8 p-2 px-4 ml-3 font-bold text-xl rounded-lg z-10 w-fit h-12 border border-gray-900 bg-gray-600 ">Bidders : {quote.bidders}</div>
      </div>
          </Link>
        ))}
      </div>
